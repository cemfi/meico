...
//        stage.setMinWidth(705);
    ...
    /**
     * read the settings file meicoApp.cfg
     * @throws IOException
     */
    protected static void readSettings() throws IOException {
        File file = new File("meicoApp.cfg");
...
//                + "\n\n# useInternalWebView\n" + (Settings.useInternalWebView ? "1" : "0")
        ...
        PrintWriter writer;
        try {
            writer = new PrintWriter("meicoApp.cfg", "UTF-8");
